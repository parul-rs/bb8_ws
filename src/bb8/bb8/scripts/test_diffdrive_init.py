...
class cas_command:
    ...
    def __init__(self, N):
        ...
        self.r = 0.00635 # radius of wheel in meters
        self.L = 0.0381 # radius of wheel in meters
        
        # -------------------------------------------------------------------------------------------
        # Defining EOM
        self.theta = cas.SX.sym("theta") # heading
        self.v_r = cas.SX.sym("v_r") # velocity of right wheel
        self.v_l = cas.SX.sym("v_l") # velocity of left wheel
        self.x = cas.SX.sym("x") # x axis translation
        self.y = cas.SX.sym("y") # y axis translation
